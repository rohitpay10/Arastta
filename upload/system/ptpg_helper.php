...
class PTPGModule
{
     ...
     * @return string [description]
     */
    public function handleResponse($variables)
    {
        ...
        $method = "AES-256-CBC";
        //print_r($method);exit();
        $encrptedString  = openssl_decrypt($variables, $method, $CryptoKey, 0, $iv);
