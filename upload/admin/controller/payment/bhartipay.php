...
class ControllerPaymentBhartipay extends Controller
{
    ...
    public function index()
    {
        ...
        $data['entry_hosted_key']   = $this->language->get('entry_hosted_key');
        ...
        $data['entry_sort_order']   = $this->language->get('entry_sort_order');
         ...
         $data['help_request'] = $this->language->get('help_request');
        ...
        if (isset($this->error['security'])) {
         ...
         if (isset($this->error['hosted_key'])) {
            $data['error_hosted_key'] = $this->error['hosted_key'];
        } else {
            $data['error_hosted_key'] = '';
        }
        ...
        if (isset($this->request->post['bhartipay_security'])) {
         ...
         if (isset($this->request->post['bhartipay_hosted_key'])) {
            $data['bhartipay_hosted_key'] = $this->request->post['bhartipay_hosted_key'];
        } else {
            $data['bhartipay_hosted_key'] = $this->config->get('bhartipay_hosted_key');
        }

        $data['callback'] = HTTP_CATALOG ."$return_url_for_store";
    ...
    protected function validate()
    {
        ...
        if (!$this->request->post['bhartipay_security']) {
         ...
         if (!$this->request->post['bhartipay_hosted_key']) {
            $this->error['hosted_key'] = $this->language->get('error_hosted_key');
        }
